...
import com.datricle.datriclerun.databinding.FragmentSetupBinding
...
class SetupFragment : Fragment(R.layout.fragment_setup) {
    ...
    private var sideAnim: Animation? = null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        //Animations
        sideAnim = AnimationUtils.loadAnimation(context, R.anim.bottom_anim)
        binding.etLayout.animation = sideAnim
